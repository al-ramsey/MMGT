...
in \(\mathcal{A}\) such that \(d(n-1)\circ d(n)=0\) for all \(n \in \int\). The collection of chain complexes with values in \(\mathcal{A}\) is an additive category, \(\Ch(\mathcal{A})\). 
\end{definition}
