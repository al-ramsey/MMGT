...
We are finally ready to define symmetric monoidal \(\infty\)-categories; the following definitions are now almost identical to those for symmetric monoidal \(1\)-categories.
